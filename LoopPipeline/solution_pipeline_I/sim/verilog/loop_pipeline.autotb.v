...
`define AUTOTB_DUT      loop_pipeline
`define AUTOTB_DUT_INST AESL_inst_loop_pipeline
`define AUTOTB_TOP      apatb_loop_pipeline_top
`define AUTOTB_LAT_RESULT_FILE "loop_pipeline.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "loop_pipeline.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_loop_pipeline_top
...
`define AUTOTB_TVIN_A_out_wrapc  "../tv/rtldatafile/rtl.loop_pipeline.autotvin_A.dat"
`define AUTOTB_TVOUT_ap_return  "../tv/cdatafile/c.loop_pipeline.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "../tv/rtldatafile/rtl.loop_pipeline.autotvout_ap_return.dat"
module `AUTOTB_TOP;
