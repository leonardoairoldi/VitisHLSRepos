...
if {[file isfile loop_pipeline.autotvin.dat]} {
	file delete -force loop_pipeline.autotvin.dat
}

if {[file isfile loop_pipeline.autotvout.dat]} {
	file delete -force loop_pipeline.autotvout.dat
}
