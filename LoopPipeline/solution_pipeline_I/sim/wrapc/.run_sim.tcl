...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "loop_pipeline.autotvin.dat"
	set constFileTvOut       "loop_pipeline.autotvout.dat"
	set constFileHdlTvIn     "loop_pipeline.autohdltvin.dat"
	set constFileHdlTvOut    "loop_pipeline.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
